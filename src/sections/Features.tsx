            ...
            <div className="container">
                ...
                <div className="mt-12 grid grid-cols-1 md:grid-cols-4 lg:grid-cols-3 gap-8">
                    ...
                    <FeatureCard
                        ...
                        description="Enagage your clients with prototypes that reacts
                                to user actions"
                        className="md:col-span-2 lg:col-span-1 group"
                    >
                        <div className="aspect-video flex items-center justify-center">
                    ...
                    <FeatureCard
                        ...
                        description="Powerful commands to help you create designs
                                more quickly"
                        className="md:col-span-2 lg:col-span-1 md:col-start-2 lg:col-span-auto group"
                    >
                        <div className="ascpect-video flex items-center justify-center gap-4">
